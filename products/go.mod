module github.com/vniche/distributed-tracing/products

go 1.16

require (
	github.com/vniche/distributed-tracing/common v0.0.1-alpha
	github.com/vniche/distributed-tracing/orders v0.0.1-beta
...
// replace github.com/vniche/distributed-tracing/tracing => ../tracing
